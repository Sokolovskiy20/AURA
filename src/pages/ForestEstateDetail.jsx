...
const ForestEstateDetail = () => {
  const [sliderPos, setSliderPos] = useState(50);

  // Сценарии
  const scenarios = [
    { time: 'Утро', title: 'Пробуждение в лесу', desc: <>С первыми лучами солнца умные шторы бесшумно открываются на 30%, открывая<br/>вид на туманный сосновый лес. Теплый пол прогревается до идеальных 24°C.</>, img: './images/forest_morning_hq_1782971426038.jpg' },
    { time: 'День', title: 'Единение с природой', desc: <>Огромные панорамные окна стирают границу между интерьером и лесом. Биодинамический<br/>свет внутри дома точно повторяет цветовую температуру солнца за окном.</>, img: './images/forest_day_hq_1782971459166.jpg' },
    { time: 'Вечер', title: 'Уютная приватность', desc: <>Лес погружается во тьму, а внутри загорается теплая янтарная подсветка.<br/>Опускаются плотные шторы, активируется камин и невидимая акустика.</>, img: './images/forest_evening_hq_1782971485833.jpg' },
    { time: 'Ночь', title: 'Неприступная крепость', desc: <>Умный дом переходит в ночной режим. Фасадная подсветка выделяет архитектуру на фоне<br/>темных сосен, в то время как невидимый лазерный периметр берет территорию под охрану.</>, img: './images/forest_night_hq_1782971535534.jpg' }
  ];

  return (
    <div style={{ backgroundColor: '#000', minHeight: '100vh', overflowX: 'hidden' }}>
      <Helmet>
        <title>Forest Estate | AURA Умный Дом</title>
        <meta name="description" content="Загородная резиденция Forest Estate. Технологическая экосистема в гармонии с природой." />
      </Helmet>
      ...
      <section style={{ position: 'relative', height: '100vh', width: '100vw', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden' }}>
        <img src="./images/forest_hero_apple_1782971244210.jpg" alt="Forest Estate" style={{ position: 'absolute', width: '100%', height: '100%', objectFit: 'cover', opacity: 0.8 }} />
        <div style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', background: 'linear-gradient(to bottom, rgba(0,0,0,0.6) 0%, rgba(0,0,0,0.1) 50%, #000 100%)' }}></div>
        
        <motion.div initial="hidden" animate="visible" variants={fadeUp} style={{ position: 'relative', zIndex: 1, textAlign: 'center', padding: '0 20px' }}>
          <div style={{ color: 'var(--accent-gold)', textTransform: 'uppercase', letterSpacing: '0.2em', marginBottom: '20px', fontSize: '0.9rem' }}>Загородная резиденция</div>
        ...
        <div className="container">
          <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: '60px' }}>
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "0px" }} variants={fadeUp} style={{ flex: '1 1 400px' }}>
              <h2 className="title-section" style={{ marginBottom: "30px", color: "#fff" }}>Никаких устройств.<br />Только пространство.</h2>
              <p className="text-lead" style={{ color: "rgba(255,255,255,0.6)", marginBottom: "20px" }}>
                Мы убеждены, что настоящая роскошь — это когда технологии служат вам, оставаясь абсолютно незаметными.
              </p>
              <p className="text-lead" style={{ color: "rgba(255,255,255,0.6)", marginBottom: "20px" }}>
                В Forest Estate вы не найдете пластиковых датчиков или выключателей. Вся инженерия скрыта в деревянных панелях и архитектурных элементах. Ваш взгляд должен скользить сквозь панорамные окна в сосновый лес, не отвлекаясь на технологии.
              </p>
            </motion.div>
            <motion.div 
            ...
            >
              <img src="./images/forest_interior_hq_1782971398014.jpg" alt="Чистый интерьер в лесу" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
            </motion.div>
          </div>
        </div>
      </section>
      ...
      <section className="section" style={{ backgroundColor: '#050505', padding: '150px 0', position: 'relative', overflow: 'hidden' }}>
        ...
        <div className="container" style={{ textAlign: 'center' }}>
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "0px" }} variants={fadeUp} style={{ marginBottom: '100px' }}>
            <h2 className="title-section" style={{ color: '#fff' }}>Единая система</h2>
            <p className="subtitle" style={{ maxWidth: '600px', margin: '16px auto 0' }}>Три невидимых слоя, которые делают дом живым.</p>
          </motion.div>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '500px', perspective: '1200px' }}>
            ...
            >
              ...
              >
                <div>
                  <h3 style={{ color: '#fff', fontSize: '1.5rem', marginBottom: '10px' }}>1. Эстетика</h3>
                  <p style={{ color: 'rgba(255,255,255,0.5)', fontSize: '0.9rem', margin: 0 }}>Чистый интерьер</p>
                </div>
              </motion.div>
              ...
              >
                <div>
                  <h3 style={{ color: 'var(--accent-gold)', fontSize: '1.5rem', marginBottom: '10px' }}>2. Инженерия</h3>
                  <p style={{ color: 'rgba(229,195,135,0.6)', fontSize: '0.9rem', margin: 0 }}>Скрытые датчики и сети</p>
                </div>
              </motion.div>
              ...
              >
                <div>
                  <h3 style={{ color: '#fff', fontSize: '1.5rem', marginBottom: '10px' }}>3. Интерфейс</h3>
                  <p style={{ color: 'rgba(255,255,255,0.8)', fontSize: '0.9rem', margin: 0 }}>Приложение AURA и голос</p>
                </div>
              </motion.div>
            </motion.div>
      ...
      <section style={{ backgroundColor: '#000' }}>
        <div style={{ textAlign: 'center', padding: '100px 0 60px' }}>
          <h2 className="title-section" style={{ color: '#fff' }}>Один день в резиденции</h2>
        </div>
      ...
      <section className="section" style={{ backgroundColor: '#000', padding: '150px 0' }}>
        <div className="container" style={{ textAlign: 'center' }}>
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "0px" }} variants={fadeUp} style={{ marginBottom: '80px' }}>
            <h2 className="title-section" style={{ color: '#fff' }}>Магия света</h2>
            <p className="subtitle" style={{ maxWidth: '600px', margin: '16px auto 0' }}>Потяните ползунок, чтобы увидеть разницу между обычным интерьером и активированным сценарием AURA.</p>
          </motion.div>
          ...
          <div style={{ position: 'relative', width: '100%', maxWidth: '1000px', height: '60vh', minHeight: '400px', margin: '0 auto', borderRadius: 'var(--radius-lg)', overflow: 'hidden', cursor: 'ew-resize', boxShadow: '0 30px 60px rgba(0,0,0,0.5)' }}>
            ...
            {/* Изображение "ДО" (Тусклое, обычное) */}
            <img 
              src="./images/forest_slider_hq_1782971567164.jpg" 
              alt="До" 
              style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover', filter: 'brightness(0.4) grayscale(0.6)' }} 
            />
            
            {/* Текст ДО (он всегда виден на правой части) */}
            <div style={{ position: 'absolute', top: '30px', right: '30px', color: '#fff', fontSize: '1.2rem', fontWeight: 'bold', textShadow: '0 2px 10px rgba(0,0,0,0.8)', textAlign: 'right' }}>БЕЗ УМНОГО ДОМА</div>

            {/* Изображение "ПОСЛЕ" (Яркое, умное) - обрезается по ползунку */}
      ...
      <section className="section" style={{ backgroundColor: 'var(--bg-secondary)', position: 'relative' }}>
        ...
        <div className="container" style={{ textAlign: 'center', position: 'relative', zIndex: 1 }}>
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "0px" }} variants={fadeUp} style={{ marginBottom: '80px' }}>
            <h2 className="title-section" style={{  }}>Слово владельцу</h2>
          </motion.div>
          ...
          <div style={{ maxWidth: '850px', margin: '0 auto', textAlign: 'left' }}>
            ...
            >
              ...
              <p style={{ position: 'relative', zIndex: 1, fontSize: '1.4rem', fontStyle: 'italic', lineHeight: 1.8, marginBottom: '40px', color: '#fff' }}>
                Самое удивительное в Forest Estate — это то, как дом чувствует нас. Он словно живой организм. Утром он мягко будит светом, а вечером сам создает интимную атмосферу. При этом мы нигде не видим никаких панелей или колонок — вся магия скрыта внутри стен.
              </p>
...
export default ForestEstateDetail;
